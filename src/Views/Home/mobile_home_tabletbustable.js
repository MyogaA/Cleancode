...
import { DualMonitorOrder } from "../../Libraries/DualScreenFunctions";
...
export default class MobileHomeTablet extends Component {
      ...
      if (state.isConnected) {
        ...
        OfflineMenuFunctions.GetLastUpdate(val => {
          ...
          if (val) {
            ...
            setTimeout(() => {
              console.log("Update by last update default");
              this.getAllData();
            }, 1500);
          }
        });
  ...
  importData(time = this.state.lastUpdate) {
    ...
    if (timeDifferenceSecond > 300) {
      ...
      let uri_product = `${BE_Get_Product}?outlet_id=${gerai_id}&status=active&search=&page=1`;
        ...
        >
          <Button
            onPress={() => {
              ...
              this.getMenuByCategory("", activeCategory, i); /// ga dipake
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text
                style={[MainStyle.robotoNormal, { fontSize: 13, color: BLACK }]}
              >
      ...
      <View style={[styles.body]}>
        ...
        >
          ...
          >
            <View
              style={{
                ...
                borderRadius: formItem ? 0 : 0,
                borderWidth: formItem ? 0 : 0,
          ...
          >
            ...
            <DualMonitorOrder state={this.state} />
          </View>
        </View>
