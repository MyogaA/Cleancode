...
import { _kembali, _server_down } from "../../Libraries/DictionaryLogin";
...
import { DualMonitorOrder, DualMonitorOrderVersion2 } from "../../Libraries/DualScreenFunctions";
...
export default class MobileHomeTablet extends Component {
  constructor(props) {
    super(props);
    this.arrLoc = [];
    this.state = {
  ...
  componentDidMount() {
    ...
    MenuFunctions.GetTableID(val => {
      if (val) {
        ...
        console.log("selectedSalesType 1 ==> ", this.state.sales_type_dine_in_id);
        this.setState({
          savedTableId: val,
    ...
    console.log("17.2")
        ...
        //   ; //syct data transaksi yg pending
        ...
        OfflineMenuFunctions.GetLastUpdate(val => {
          console.log("Get Last Update ==> ", val);
          console.log("18")
          ...
          if (val) {
            ...
            setTimeout(() => {
              ...
              if (timeDifferenceSecond > 300) {
                ...
                console.log("Update by last update");
                // this.getAllData();
                this.getData();
            ...
            setTimeout(() => {
              ...
              const time_now = moment(new Date()).format("YYYY-MM-DD HH:mm:ss");
              OfflineMenuFunctions.SaveLastUpdate(time_now, val => {});
              console.log("update all data first time");
              // this.getAllData();
              this.getData();
    ...
    if (this.state.direct_payment) {
      setTimeout(() => {
       ...
       let data_temp =  moment(new Date()).format("YY/MM/DD-HH/mm/ss") +
       "-" +
       this.state.userInfo.gerai_id;

        Actions.MobileBayarTablet({
  ...
  resetWeight() {
    ...
    try {
      ScalingFunctions.CalculateWeight(v => {});
      setTimeout(() => {
        ScalingFunctions.ResetWeight(v => {});
      }, 100);
    } catch (error) {
  ...
  calculateWeight() {
    ...
    try {
      ScalingFunctions.CalculateWeight(v => {
        console.log("Calculate Weight ====> ", v.message);

        const result = parseFloat(v.message);
        this.setState({ selectedQuantity: result });
      });
    } catch (error) {
      console.log("starter error");
    }
  ...
  componentDidUpdate(nextProps) {
    ...
    if (this.props !== nextProps) {
      ...
      // console.log('COMPONENT DID UPDATE HOME changeSetting ==> ', nextProps.changeSetting);
      // if (nextProps.changeSetting)
      // {
      //   RegionFunctions.GetSettingLightMode(val => {
      //     if (val) {
      //       this.setState({ setting_light_mode: val });
      ...
      // if(nextProps.table)
      // {
      //   this.setState({tempTableProps: nextProps.table})
      // }
      ...
      //   //   refresh: true
      //   // });
      //   this.newOrderCheckIn(false, false, nextProps.table);
      //   this.setState({ action: "1", salesTypeName: "Dine-In" });
    ...
    //   this.setState({ transactionId: kode, mount: true });
  ...
  newOrderCheckIn(showAlert = false, cancel = false, table = null) {
    // this.setState({ loading: true });
    this.cancelOrder(
      showAlert,
      cancel,
  ...
  getDataTable(tabledata = null) {
    ...
    let check_in_table = this.props.table
      ? this.props.table
    ...
    if (this.state.tempTableProps)
    {
      check_in_table = this.state.tempTableProps;
    }
    ...
    fetch(uri, {
      ...
      .then(responseJson => {
        ...
        if (finalResult.length > 0) {
          // console.log("Final Result selectedTable ===> ", selectedTableData);
          this.setState({
  ...
  getData(
    ...
    //let uri = `${GetMenuFavAPI}?gerai_id=${gerai_id}&search=&page=1`;
    let uri = `${BE_Get_Product}/lite?outlet_id=${gerai_id}${is_favorite}&name=${search}&status=active&per_page=18&page=${page}`;
    // console.log("uri get data ==> ", uri);
    // console.log ("activeCategory ", activeCategory)
    NetInfo.fetch().then(state => {
          ...
          .then(responseJson => {
            ...
            if (responseJson.statusCode === 200) {
              ...
              if (barcodeSearch) {
                ...
                if (data) {
                  console.log("DATA PRODUCT SINGLE ===> ", data.Product);
                ...
                if (page === 1 && resultData.data.length === 1)
                {
                  OfflineMenuFunctions.SaveAllMenu(resultData.data, x => {});
                }
                ...
                if (
                  ...
                  //console.log("search barcode data ", data);
                  if (get_data) {
                    this.setState({ searchKey: "", loading: false, });
          ...
          .catch(_err => {
            if (activeCategory === -1) {
              OfflineMenuFunctions.GetAllMenu(val => {
                ...
                //this.setState({ lastUpdate: val });
                if (val) {
                  console.log("offline first data", val[0]);
              ...
              OfflineMenuFunctions.GetFavMenu(val => {
                ...
                //this.setState({ lastUpdate: val });
                if (val) {
                  console.log("offline first data 3 ", val[0]);
    ...
    NetInfo.fetch().then(state => {
      if (state.isConnected) {
        fetch(uri, {
          ...
          .then(response => response.json())
          .then(responseJson => {
            // console.log("getData Category responseJson ==> ", responseJson);
  ...
  getMenuByCategory(
    ...
    NetInfo.fetch().then(state => {
      if (state.isConnected) {
        ...
        all_menu.map((v, i) => {
          // console.log("v all menu ", v);

          //console.log("v.product_category_id ", v.product_category_id);
  ...
  deleteBill(index) {
    ...
    setTimeout(() => {
      ...
      MenuFunctions.SaveMenu(dataBill, val => {
        ...
        this.setState({ dataBill: val, loading: false });
      });
    }, 100);
  ...
  addOrder() {
    ...
    console.log("selected add product ==> ", selectedProduct);
    ...
    let dataAdd = {
      ...
      // total: (salesTypeValue_temp + productPrice_temp) * selectedQuantity,
      total: harga_total,
    ...
    // console.log("Data Add New ==> ", dataAddNew);
    ...
    if (formAction === "add") {
      ...
      console.log("Sukses Add dataBill ===> ", dataBill);
      this.setState({
        dataBill: dataBill,
        formItem: false,
        showBill: showBill
  ...
  checkOutNew() {
    ...
    console.log("Dine-In ID ==> ", this.state.sales_type_dine_in_id);
    ...
    if (
      ...
      console.log("Dine-In 2 ==> ", table_id);
    ...
    // console.log("items new order==> ", items);
    // console.log("table_id new order ==> ", table_id);
    // console.log("receipt_id new order ==> ", kode);
  ...
  showFormItem(product, price, action = "add") {
    // this.setState({ loading: true });
    this.setState({formItem: true})

    let all_addons = product.Group_Addons;
    console.log("showFormItem price ==> ", price);
    //console.log("showFormItem product ==> ", product);

    let new_price = this.state.currencyAllowDecimal
      ? parseFloat(price).toFixed(2)
      : parseInt(price);

    console.log("showFormItem new_price ==> ", new_price);
    // if (action = "edit")
    console.log("Get Addons Offline ==> ", all_addons);
  ...
  changeChecklistDone(index, value) {
    ...
    MenuFunctions.SaveMenu(dataBill, val => {
      console.log("Sukses Change checklist");
    });
    this.setState({ dataBill: dataBill });
  }
  ...
  handleLoadMore() {
    ...
    console.log("handle load activecategory ", this.state.activeCategory);
  ...
  renderKategoriTop(data, index) {
    ...
    return (
      <Button
        onPress={() => {
          this.getMenuByCategory("", data.id, index + 1, 1); //yang dipakai
          // LayoutAnimation.configureNext(
          //   LayoutAnimation.Presets.easeInEaseOut
          // );
        ...
        style={{
          ...
          backgroundColor: this.state.activeCategory === data.id && !showFilter ? 
            MAIN_THEME_COLOR_SELECT(this.state.colorIndex) : WHITE,
          marginRight: 5,
          borderRadius: 5
          //alignItems: 'center',
        }}
      ...
      return (
        ...
        >
          ...
          >
            ...
            <Button
              onPress={() => {
                this.getData("", -1, 1); //setting page = 1
              }}
              style={{
                marginTop: 0,
                //width: "100%",
                ...
                borderBottomWidth:
                  this.state.activeCategory === -1 && !this.state.showFilter
                    ...
                    : 0,
                //alignItems: 'center',
                backgroundColor: this.state.activeCategory === -1 && !this.state.showFilter ? 
                MAIN_THEME_COLOR_SELECT(this.state.colorIndex) : WHITE,
                marginRight: 5,
                borderRadius: 5
              }}
              ...
              <Text
                style={[
                  MainStyle.robotoNormalBold,
                  {
                    ...
                    color:
                      this.state.activeCategory === -1 && !this.state.showFilter
                        ? WHITE : MAIN_THEME_COLOR_SELECT(this.state.colorIndex)
                  }
                ]}
              >
              ...
              style={{
                ...
                borderBottomWidth:
                  this.state.activeCategory === 0 && !this.state.showFilter
                    ? 5
                    : 0,
                    backgroundColor: this.state.activeCategory === 0 && !this.state.showFilter ? 
                    MAIN_THEME_COLOR_SELECT(this.state.colorIndex) : WHITE,
                marginRight: 5,
                borderRadius: 5
                //alignItems: 'center',
      ...
      >
        ...
        >
          <Button
            ...
            style={{ borderRadius: 15, flex: 1, padding: 5 }}
          >
            <Text
        ...
        >
          ...
          >
            {data.nego ? (
              ...
              <Text
                style={[MainStyle.robotoNormal, { fontSize: 13, color: WHITE }]}
              >
        ...
        >
          ...
          >
            <Text
              style={[MainStyle.robotoNormal, { fontSize: 10, color: WHITE }]}
            >
              {detailString}
            </Text>
        ...
        >
          ...
          >
            ...
            <Text
              style={[
                MainStyle.robotoNormal,
                { fontSize: 10, color: WHITE, alignSelf: "center" }
              ]}
            >
          ...
          <View
            style={{
              ...
              //display: this.state.order_id ? "flex" : "flex",dishow bentaran
              alignContent: "flex-end",
              width: "50%",
              marginTop: 5,
              flexDirection: "row"
  ...
  renderDetailBill(data, i) {
    let detail = data.detail ? data.detail : null;
    let detailString = "";

    let image = "";
    //console.log("RenderBill ===> ", data);asas
                ...
                {this.state.loading === false && type === "single" ? (
                  this.state.tablet ? (
                    ...
                    <FlatList
                      ...
                      numColumns={1}
                      keyExtractor={(item, index) => {
                        return "ListAdditionalSubSingle2" + index.toString();
                      }}
                      //onRefresh={this._onRefresh}
                      //onEndReached={this.handleLoadMore}
                      //onEndReachedThreshold={0.5}
                  ...
                  this.state.tablet ? (
                    ...
                    <FlatList
                      ...
                      numColumns={1}
                      keyExtractor={(item, index) => {
                        return "ListAdditionalSubMulti2" + index.toString();
                      }}
                      //onRefresh={this._onRefresh}
                      //onEndReached={this.handleLoadMore}
                      //onEndReachedThreshold={0.5}
                  ...
                  <View style={{ marginTop: 0, padding: 0 }}>
                    ...
                    >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  {_reset_weight[this.state.languageIndex]}
                                </Text>
                              </Button>
                              <Button
                                onPress={() => {
                              ...
                              >
                                ...
                                >
                                  {_calculate_weight[this.state.languageIndex]}
                                </Text>
                              </Button>
                            </View>
                          </View>
                      ...
                      <FlatList
                        ...
                        //ListFooterComponent={this._renderFooter}
                        keyExtractor={(item, index) => {
                          return "ListAdditionalsss" + index.toString();
                        }}
                        //onRefresh={this._onRefresh}
                        //onEndReached={this.handleLoadMore}
                        //onEndReachedThreshold={0.5}
                        ...
                        <View style={{ marginLeft: 15, marginRight: 15 }}>
                          {this.state.tablet ? (
                            <FlatList
                              ...
                              //ListFooterComponent={this._renderFooter}
                              keyExtractor={(item, index) => {
                                return "ShowSalesType1" + index.toString();
                              }}
                            />
                          ) : (
                            <FlatList
                              ...
                              //ListFooterComponent={this._renderFooter}
                              keyExtractor={(item, index) => {
                                return "ShowSalesType2" + index.toString();
                              }}
                            />
                          )}
                        </View>
                  ...
                  <View style={{ marginTop: 0, padding: 0 }}>
                    ...
                    >
                      ...
                      <FlatList
                        ...
                        //ListFooterComponent={this._renderFooter}
                        keyExtractor={(item, index) => {
                          return "ListAdditional2" + index.toString();
                        }}
                        //onRefresh={this._onRefresh}
                        //onEndReached={this.handleLoadMore}
                        //onEndReachedThreshold={0.5}
                ...
                >
                  ...
                  >
                    <Text
                      style={[
                        MainStyle.robotoNormalBold,
                        { fontSize: 40, color: BLACK, textAlign: "center" }
                      ]}
                    >
                      {short_name}
                    </Text>
  ...
  renderDataProduct() {
    ...
    if (this.state.showFavList === true) {
      return (
        // <GestureRecognizer
        //   onSwipeLeft={() => {
  ...
  renderDataBill() {
    ...
    let table = this.state.selectedTable ? this.state.selectedTable.name : "No Table";
      ...
      >
        ...
        >
          <View style = {{flexDirection: "row", justifyContent:"space-between"}}>
            ...
            >
              {/* ORDERS - {table} - {this.state.transactionId} */}
              ORDERS
            </Text>
            <Button onPress={() => {this.setState({ showClearCartBackHandler: true });}}>
              <Text
              style={[
                MainStyle.robotoNormalBold,
                {
            ...
            this.state.dataBill.length > 1 ? (
              <FlatList
                ...
                renderItem={({ item, index }) => {
                  return (
                    <View style={{ width: "100%" }}>
                      {this.renderDetailBill(item, index)}
                    </View>
                  );
                }}
                //ListFooterComponent={this._renderFooter}
              ...
              <FlatList
                ...
                //ListFooterComponent={this._renderFooter}
                keyExtractor={(item, index) => {
                  return "RenderBill2" + index.toString();
                }}
              />
            )
          }
          ...
          >
            ...
            >
              ...
              >
                {this.state.currency} {this.idrNumToStr(subTotal)}
              </Text>
            </View>
          </View>
          <View
          ...
          >
            ...
            >
              <View
                style={{
                  display: this.state.access_change_tax ? "none" : "none"
                }}
              >
                {/* <Checkbox
                  color={MAIN_THEME_COLOR_SELECT(this.state.colorIndex)}
        ...
        <View
          style={{
            ...
            width: this.state.tablet ? "100%" : "100%",
            alignSelf: "center",
            display: this.state.formItem ? "none" : "flex"
            // flexDirection: "row"
          }}
        >
          <View
          ...
          >
            ...
            <Button
              ...
              style={{
                ...
                borderRadius: 5,
                elevation: 1,
                width: this.state.order_id ? "25%" : "100%",
                //height: 66,
                padding: 5,
                marginTop: 5,
                justifyContent: "center",
          ...
          >
            ...
            <View style={{ width: "33%", justifyContent: "space-between" }}>
              ...
              >
                <Text
                  style={
                    ([MainStyle.robotoNormal], { fontSize: 15, color: WHITE })
                  }
                >
                  Update Order
                </Text>
    ...
    return (
      <View style={[styles.body]}>
        ...
        <MobileHeaderTabletV2
          ...
          searchKeyUpdateAction={(v) => this.setState({searchKey: v})}
          colorIndex={this.state.colorIndex}
          logoutAction={() => this.logoutAction()}
        ...
        {this.state.loading || this.state.direct_payment ? (<View/>) : (
        <View
          style={{
            //flexDirection: "column",
            padding: 15,
        ...
        >
          ...
          >
            ...
            >
              ...
              <View style={{ display: this.state.formItem ? "flex" : "none" }}>
                {this.renderFormItemNormal()}
              </View>
            ...
            >
              ...
              <View style={{ flex: 1 }}>{this.renderDataBill()}</View>
            </View>
          </View>
        ...
        <View
          ...
          >
            ...
            <DualMonitorOrderVersion2 state={this.state} />
          </View>
