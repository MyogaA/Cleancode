...
export default class MobileMainMenu extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      access_attendance_management: false,
        ...
        >
          ...
          >
            ...
            <LinearGradient
              ...
              colors={["rgba(12,55,106, 0.5)", "rgba(217,217,217, 0.7)", "rgba(217,217,217, 0.25)"]}
              style={{
                ...
                // paddingLeft: 30,
                // paddingRight: 30,
                // backgroundColor:"#52BFD8",

                // backgroundColor:"#0C376A",
    ...
    return (
      ...
      >
        ...
        >
          ...
          <View style={{ flex: 0.1 , display:"none"
          // backgroundColor: "#0C376A"
          }}>
            {/* <Image
              style={{
