        ...
        >
          ...
          >
            ...
            <Text
              style={[
                ...
                { color: "#7AB93C", fontSize: 24, textAlign: "center" }
              ]}
            >
              BeetPOS
            </Text>
          ...
          <View style={{ flex: 1, flexDirection: "column", marginTop: 15 }}>
            ...
            >
              ...
              <Button
                onPress={() => {
                  Actions.MobileLogin({ colorIndex: this.state.colorIndex });
        ...
        >
          ...
          >
            ...
            >
              ...
              <View style={{ width: "95%" }}>{this.contentRightSide()}</View>
            </View>
            {/* </ScrollView> */}
          </View>
          {this.modalOTP()}
