...
export default class MobileSetting extends Component {
  ...
  async print(address_printer, address_printer2) {
    ...
    await BluetoothEscposPrinter.printText(`Cashier ${cashier_name} ${time}\n\r`, {
      encoding: "GBK",
      codepage: 0,
      widthtimes: 0,
      heigthtimes: 0,
      ...
      >
        ...
        <Button
          ...
          style={[
            ss.menuButton,
            {
              display: this.state.androidLevel > this.state.androidLevelPrinterMax ? "none" : "flex",
              borderBottomWidth: 1,
              borderColor: "#C8C7CC",
              paddingRight: 15,
              paddingLeft: 15
      ...
      >
        ...
        <Button
          onPress={() => {
            ...
            this.setState({
              currencyAllowMultiCurrency: !this.state.currencyAllowMultiCurrency
            });
          }}
          style={[
            ss.box,
  ...
  sendPushNotifTest() {
    ...
    const body = {
      ...
      contents: {
        en:
          "Proses booking untuk kode: BOOKING_1/1/1/2020-04-22-18-02 telah dikonfirmasi oleh pihak restoran. Nomor meja anda adalah Meja 2.",
        es:
          "Proses booking untuk kode: BOOKING_1/1/1/2020-04-22-18-02 telah dikonfirmasi oleh pihak restoran. Nomor meja anda adalah Meja 2."
      },
      headings: {
          ...
          <View style={[ss.mainContent, { flexDirection: "column" }]}>
            ...
            >
              ...
              <View style={[ss.rightSide]}>
                ...
                {activeMenu === 4 ? this.renderGantiPassword() : <View />}
