...
export default class MobileDemoPrinter extends Component {
  constructor(props) {
    super(props);
    this.state = {
      custom_name: "",
  ...
  testPrintParameter()
  {
    ...
    AutoPrintFunctions.PrintFunction(title, head, tail, invoice, sub_total, discount, tax, services, total, bayar, kembali, nameData, numData, amountData, v => {
      alert("success print");
    })
    ...
    //         if (i === dataLength)
    //         {
    //           AutoPrintModule.printParameter(title, head, tail, invoice, sub_total, discount, tax, services, total)
  ...
  testPrintRekap()
  {
    let nameData = ["Product nomor satu 1", "Product dua 2", "Tiga Product 3", "Empat Product 4"];
    let numData = [1,2,3,4];
    let amountData = [1000,2000,3000,4000];
  ...
  checkBluetooth() {
    BluetoothManager.isBluetoothEnabled().then(
      (enabled) => {
        ...
        if (enabled === false) {
          console.log("Bluetooth Enabled false");
      ...
      >
        ...
        <Button
          onPress={() => {
            ...
            this.TestConnectToPrinter();
          }}
          style={[
            ss.menuButton,
            {
              // display: this.state.allowPrinterInternal ? "flex" : "none",
              borderBottomWidth: 1,
              display: "none",
              borderColor: "#C8C7CC",
              paddingRight: 15,
        ...
        >
          <View style={{ width: "100%" }}>
            <Text
              style={[MainStyle.robotoNormal, { fontSize: 15, color: BLACK }]}
            >
              Get Connected Printer New Function
            </Text>
          </View>
        </Button>
