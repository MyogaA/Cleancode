...
import SunmiInnerScanner, {
  SunmiScannerView,
} from 'react-native-sunmi-inner-scanner';
  ...
  render() {
    return (
      <View style={styles.container}>
        <View>
          <Text>Scan Result 1:{this.state.result}</Text>
        </View>
        <View
        ...
        >
          <TouchableOpacity
            ...
            onPress={() => this._openDefaultScanner()}
          >
            <Text style={{ fontSize: 16 }}>Default Scanner</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.buttonstyle}
            onPress={() => this._openScannerWithOptions()}
          >
