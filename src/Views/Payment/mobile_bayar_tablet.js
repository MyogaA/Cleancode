...
export default class MobileBayarTablet extends Component {
  constructor(props) {
    super(props);
    this.state = {
      queue_number: 0,
  ...
  componentDidMount() {
    ...
    PrinterFunctions.GetBusinessData(val => {
      ...
      if (val) {
        ...
        val.cz_pin ? this.setState({cz_invalid: false}) : "";
  ...
  *Thank you for shopping in ${business_name}-${gerai_name}*
    ...
    return (
      <View
        style={
          {
            //marginTop: 10,
            display: this.state.showCash ? "flex" : "none"
          }
        }
      >
        <View
        ...
        style={
          {
            //marginTop: 10,
            display:
                this.state.payment_method_wallet.length !== 0 && this.state.showWallet ? "flex" : "none"
          }
        }
      >
        <View
  ...
  renderCardPayment() {
    ...
    return (
      <View
        style={{
          display: this.state.payment_method_card.length > 0 && this.state.showCard ? "flex" : "none"
          //display: "none"
          //marginTop: 10,
        }}
      >
        ...
        >
          ...
          >
            <Text
              style={[
                MainStyle.dmSans,
                { fontSize: 13, color: BLACK, right: "-25%" }
              ]}
            >
              {data.qty}
            </Text>
  ...
  renderBillList() {
    ...
    return (
      <View style={{flex:1, borderBottomColor: "#C4C4C4", borderBottomWidth: 0.5}}>
        {/* {this.renderBillHeader()} */}
        <FlatList
          //ListHeaderComponent={this.renderSearch()}
          showsVerticalScrollIndicator={false}
      ...
      <View style={[ss.body]}>
        ...
        {showPaymentSuccess ? (
          <PaymentSuccess
            ...
            showcetakDapur = {this.state.business_type === "Restaurant" ? true : false}
            cetakDapurAction={() => {
