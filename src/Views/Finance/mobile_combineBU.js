    ...
    detail2.map((item2, i2) => {
      ...
      detail1.map((item1, i1) => {
        if (item2.menu_id === item1.menu_id) {
          let detailText_1 = "";
          let detailText_2 = "";
          const detailData_1 = item1.detail;
          const detailData_2 = item2.detail;
          detailData_1.map((v, i) => {
            if (detailText_1 !== "") {
              detailText_1 = detailText_1 + ", " + v.name;
            } else {
              detailText_1 = v.name;
            }
          });
          ...
          detailData_2.map((v, i) => {
            if (detailText_2 !== "") {
              detailText_2 = detailText_2 + ", " + v.name;
            } else {
              detailText_2 = v.name;
            }
          });
  ...
  moveFromLeft(data, indexData) {
    ...
    detail2.map((item2, i2) => {
      ...
      if (item2.menu_id === data.menu_id) {
        ...
        const detailData_1 = item2.detail;
        const detailData_2 = data.detail;
