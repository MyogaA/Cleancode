              ...
              >
                <View style={{ marginTop: 0, padding: 0 }}>
                  <View style={{ margin: 15, marginBottom: 0, marginTop: 5 }}>
                    ...
                    >
                      <View style={{flexDirection: "row", width: "100%", backgroundColor: "#BCA"}}>
                      <View style= {{flex: 1, }}>
                      <Button
                        onPress={() => {
                          this.takePicture();
                  ...
                  >
                    ...
                    <View
                      style={{
                        //backgroundColor: '#BCA',
                        width: "100%",
                        display: this.state.business_type === "Restaurant" ? "none" : "flex"
                      }}
                    >
                      <View
                        style={{
      ...
      <View style={[styles.body]}>
        ...
        >
          ...
          >
            ...
            <View style={{ flex: 50, margin: 10, marginRight: 5, padding: 5, backgroundColor: WHITE }}>
              <View style={{ }}>
            ...
            <View style={{ flex: 42.5, margin: 10, marginLeft: 5}}>
            {this.renderFormItemTablet()}
            </View>
