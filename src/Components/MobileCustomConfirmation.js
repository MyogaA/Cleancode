...
export default class CustomConfirmation extends Component {
  constructor(props) {
    super(props);
    // this.state = {
    //   isOpen: true,
  ...
  render() {
    ...
    let clearText = text;
    // let clearText = [
    //   "Apakah anda yakin ingin menghapus semua pesanan dalam Keranjang?",
    //   "Are you sure to clear all orders from cart?"
    // ];
