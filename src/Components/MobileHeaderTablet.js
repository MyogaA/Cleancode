...
export default class MobileHeaderTablet extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    let bgColorTemp = bgColor ? bgColor : WHITE;
          ...
          {back ? (
            ...
            >
              <View style={styles.headerBtnView}>
                <Ionicons
                  name="md-arrow-back"
                  style={[styles.headerIcon, { color: BLACK }]}
                />
              </View>
            </Button>
          ) : (
          ...
          id_dine_in !== 0 ? (
            ...
            >
              ...
              <Dropdown_V2
                ...
                languageIndex={this.state.languageIndex}
                colorindex={this.state.colorIndex}
                cancelText={this.state.languageIndex === 0 ? "Batal" : "Cancel"}
                showButton={true}
                expand={expand}
                hideArrow={true}
                size={12}
            ...
            >
              <View style={styles.headerBtnView}>
                ...
                {cartNumber > 0 ? (
                  ...
                  >
                    <Text small bold style={{ fontSize: 12, color: WHITE }}>
