...
public class RNBluetoothManagerModule extends ReactContextBaseJavaModule
    ...
    public void scanDevices(final Promise promise) {
        ...
        if(adapter == null){
            ...
            cancelDisCovery();
            int permissionChecked2 = ContextCompat.checkSelfPermission(reactContext, android.Manifest.permission.ACCESS_FINE_LOCATION);
            int permissionChecked = ContextCompat.checkSelfPermission(reactContext, android.Manifest.permission.BLUETOOTH_CONNECT);
            int permissionChecked4 = ContextCompat.checkSelfPermission(reactContext, android.Manifest.permission.BLUETOOTH_ADVERTISE);
            int permissionChecked3 = ContextCompat.checkSelfPermission(reactContext, android.Manifest.permission.BLUETOOTH_SCAN);
            ...
            if (permissionChecked2 == PackageManager.PERMISSION_DENIED) {
                // // TODO: 2018/9/21
                // ActivityCompat.requestPermissions(reactContext.getCurrentActivity(),
                //         new String[]{android.Manifest.permission.ACCESS_COARSE_LOCATION},
                //         1);
            ...
            if (permissionChecked3 == PackageManager.PERMISSION_DENIED) {
                // // TODO: 2018/9/21
                // ActivityCompat.requestPermissions(reactContext.getCurrentActivity(),
                //         new String[]{android.Manifest.permission.ACCESS_COARSE_LOCATION},
                //         1);
            ...
            if (permissionChecked4 == PackageManager.PERMISSION_DENIED) {
                // // TODO: 2018/9/21
                // ActivityCompat.requestPermissions(reactContext.getCurrentActivity(),
                //         new String[]{android.Manifest.permission.ACCESS_COARSE_LOCATION},
                //         1);
